...
if __name__ == '__main__':
    ...
    # 格式转换
    test_data = simple_bp.load_samples(x_test, y_test, dataset='testing_data')
    training_data = simple_bp.load_samples(x_train, y_train, dataset='training_data')
    (x_train, y_train), (x_test, y_test) = mnist.load_data()
